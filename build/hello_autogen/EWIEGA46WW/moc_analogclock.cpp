...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_AnalogClock_t, stringdata0) + ofs), len 
...
const QMetaObject AnalogClock::staticMetaObject = { {
    ...
    qt_meta_stringdata_AnalogClock.offsetsAndSize,
    qt_meta_data_AnalogClock,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_AnalogClock_t
