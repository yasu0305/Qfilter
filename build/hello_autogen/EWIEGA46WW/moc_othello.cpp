...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Othello_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Othello_t qt_meta_stringdata_Othello = {
    {
QT_MOC_LITERAL(0, 7) // "Othello"
...
const QMetaObject Othello::staticMetaObject = { {
    ...
    qt_meta_stringdata_Othello.offsetsAndSize,
    qt_meta_data_Othello,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Othello_t
, QtPrivate::TypeAndForceComplete<Othello, std::true_type>
