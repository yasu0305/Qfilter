...
MainWindow::MainWindow(QWidget* parent)
    : QMainWindow(parent), timeLabel(new QLabel(this)), timer(new QTimer(this)), lineEdit(nullptr),
    ...
    connect(filteredCompleter, &FilteredCompleter::selectionConfirmed, this,
            &MainWindow::onCompleterActivated);
